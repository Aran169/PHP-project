...
$subcategory = 'Accessory'; // Use the correct subcategory name as it appears in the database
$sql = "SELECT * FROM women WHERE subcategory = ?";
                ...
                <?php while ($row = $result->fetch_assoc()): ?>
                    <div class="col-md-3 mb-4 product-card">
                        ...
                        <img src="<?php echo '../../'.$row['image_path']; ?>" class="card-img-top" alt="<?php echo $row['name']; ?>">
                            ...
                            <a href="http://localhost/project1/view.php?id=<?php echo $row['id']?>;&category=women" class="btn btn-primary">View</a>
                            <form action="../../addtocart.php" method="POST">
                                <input type="hidden" name="product_id" value="<?php echo $row['id']; ?>">
                                <input type="hidden" name="category" value="women"> <!-- or dynamically set this based on your product -->
